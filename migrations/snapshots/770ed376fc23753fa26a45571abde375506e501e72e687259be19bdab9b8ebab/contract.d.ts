...
export type StorageHash =
  StorageHashBase<'770ed376fc23753fa26a45571abde375506e501e72e687259be19bdab9b8ebab'>;
        ...
        readonly entries: {
          readonly table: {
            readonly exp: {
              ...
              indexes: readonly [
                {
                  readonly name: 'exp_profileId_idx_d9cdfcaf';
                  readonly prefix: 'exp_profileId_idx';
...
> & {
  ...
  readonly roots: {
    readonly exp: { readonly namespace: 'public' & NamespaceId; readonly model: 'Exp' };
      ...
      readonly public: {
        readonly models: {
          ...
          readonly Profile: {
            ...
            readonly relations: {
              readonly experience: {
                readonly to: { readonly namespace: 'public' & NamespaceId; readonly model: 'Exp' };
