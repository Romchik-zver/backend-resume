...
Зачем это нужно: вместо того чтобы отправлять PDF, можно дать ссылку на API —
фронтенд (или любой клиент) запрашивает только нужные поля и рисует визитку сам.
